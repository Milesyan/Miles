...
typedef NS_OPTIONS(NSInteger, BackToTodayButtonDisplayOptions) {
    HideBackToTodayButton = 0x11,
    HideBackToTodayButtonBeforeToday = 0x01,
    HideBackToTodayButtonAfterToday = 0x10,
};
...
@property (nonatomic) BackToTodayButtonDisplayOptions backToTodayButtonDisplayOptions;
