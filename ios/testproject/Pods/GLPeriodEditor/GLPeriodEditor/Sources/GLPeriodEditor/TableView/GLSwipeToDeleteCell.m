...
@interface GLSwipeToDeleteCell()
@property (nonatomic, weak) UIView *rightViewGroup;
@property (nonatomic, weak) UIButton *deleteButton;
@end

@implementation GLSwipeToDeleteCell
...
- (void)awakeFromNib {
    ...
    [deleteButton setTitle:NSLocalizedStringFromTable(@"Delete", @"GLPeriodEditorLocalizedString", nil) forState:UIControlStateNormal];
...
- (void)handlePan:(UIPanGestureRecognizer *)recognizer
{
    ...
    if (fabs(offset) > changPoint) {
        [self.deleteButton setTitle:NSLocalizedStringFromTable(@"Release to delete", @"GLPeriodEditorLocalizedString", nil) forState:UIControlStateNormal];
    } else {
        [self.deleteButton setTitle:NSLocalizedStringFromTable(@"Delete", @"GLPeriodEditorLocalizedString", nil) forState:UIControlStateNormal];
    }
