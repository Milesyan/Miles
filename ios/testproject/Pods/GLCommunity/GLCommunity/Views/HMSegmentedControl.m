...
- (void)drawRect:(CGRect)rect
{
    ...
    bottomBorder.frame = CGRectMake(0, rect.size.height, rect.size.width, 1);
    bottomBorder.backgroundColor = [UIColor lightGrayColor].CGColor;
    bottomBorder.opacity = 0.3;
    bottomBorder.shadowOpacity = 1;
    bottomBorder.shadowRadius = 2;
    bottomBorder.shadowOffset = CGSizeMake(0, 2);
    bottomBorder.shadowColor = [UIColor lightGrayColor].CGColor;
...
- (NSDictionary *)resultingTitleTextAttributes {
    NSDictionary *defaults = @{
        NSFontAttributeName : [UIFont fontWithName:@"ProximaNova-Regular" size:18.0f],
