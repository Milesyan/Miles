...
{
	return [[KKKeyDefaults getStringForKey:@"passcode_on"] isEqualToString:@"YES"];
}

- (void)setDefaultSettings
{
	if (![KKKeyDefaults getStringForKey:@"passcode_on"]) {
		[KKKeyDefaults setString:@"NO" forKey:@"passcode_on"];
	}
	
	if (![KKKeyDefaults getStringForKey:@"erase_data_on"]) {
		[KKKeyDefaults setString:@"NO" forKey:@"erase_data_on"];
	}
}
