...
#define THE_FONT [UIFont fontWithName:@"ProximaNova-Regular" size:19.0]

@interface UILinkLabel()
{
...
- (void)setCallback:(LinkClickedCallback)cb forKeyword:(NSString *)kw caseSensitive:(BOOL)caseSensitive
{
    ...
    for (NSTextCheckingResult *match in matches) {
        GLLog(@"match:%@ for:%@ ",[NSValue valueWithRange:match.range], kwInLowerCase);
